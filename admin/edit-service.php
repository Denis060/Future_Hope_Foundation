...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($title)) {
        ...
        // If no image upload errors, update the service
        if (empty($message)) {
            ...
            $stmt->bind_param("ssssiis", $title, $description, $image_path, $icon, $order_number, $is_active, $id);
            ...
            if ($stmt->execute()) {
                ...
                $message = displayError("Error updating service: " . $conn->error);
            }
...
<head>
    ...
    <title>Edit Service - <?php echo $settings['site_name'] ?? 'Future Hope'; ?> Admin</title>
    ...
    <style>
        ...
        .image-preview {
            ...
            margin-top: 10px;
            border-radius: 4px;
            display: <?php echo !empty($current_image) ? 'block' : 'none'; ?>;
        }
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card border-0 shadow-sm">
                        <div class="card-body">
                            <form action="edit-service.php?id=<?php echo $id; ?>" method="post" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="mb-3">
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <div class="current-image-container">
                                                ...
                                                <img src="../<?php echo $current_image; ?>" alt="Current Image" class="img-fluid mb-2" style="max-height: 150px;">
                                                <div class="form-text">Current image: <?php echo basename($current_image); ?></div>
                                                <?php else: ?>
                                                <div class="text-center p-3 border rounded bg-light">
                                                    <i class="<?php echo $icon ?: 'fas fa-hands-helping'; ?> fa-3x text-muted mb-2"></i>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-text"><i id="selectedIcon" class="<?php echo $icon ?: 'fas fa-hands-helping'; ?>"></i></span>
